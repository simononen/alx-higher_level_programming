...
/**
 * print_python_bytes - Print some basic info about a Python bytes object
 * @p: Parameter pointer to the Python bytes object
 */
...
/**
 * print_python_float - Print some basic info about a Python float object
 * @p: Parameter pointer to the Python float object
 */
...
/**
 * print_python_list - Print some basic info about a Python list object
 * @p: Parameter pointer to the Python list object
 */
